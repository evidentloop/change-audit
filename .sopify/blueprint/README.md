...
当前焦点是[产品身份与分发方案](../plan/20260711_identity_and_distribution/background.md)的 Wave 4；macOS arm64、Python 3.11 下的 uv wheel 与 pipx sdist 安装及断网运行已验证，Codex CLI `0.144.1` 的独立 reviewer JSONL、精确 finding 锚点和正式报告对也已通过。当前停在 Wave 4.3，等待外部试用者按清单独立完成首次安装与一句话审计。
